...
в привычном виде.
Далее реализовать перегрузку метода add() для реализации операции сложения д
вух объектов класса Matrix (двух матриц). Результатом сложения должна быть
новая матрица.
...
if __name__ == '__main__':
    matrix1 = Matrix([[31, 22], [37, 43]])
    print(matrix1, '\n')

    matrix2 = Matrix([[1, 20], [13, 41]])
    print(matrix2, '\n')
